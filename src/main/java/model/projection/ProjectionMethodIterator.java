...
public class ProjectionMethodIterator extends AugmentationMethod {
    ...
    public ProjectionMethodIterator() {
        super(AugmentationMethodType.PROJECTION, "Projection");
    }

    protected ProjectionMethodIterator(int[] xLU, int[] yLU, int[] xRU, int[] yRU, int[] xRD, int[] yRD, int[] xLD, int[] yLD) {
        super(AugmentationMethodType.PROJECTION, "Projection");
        this.xLU = xLU;
        this.yLU = yLU;
    ...
    public AugmentationMethod clone() {
        return new ProjectionMethodIterator(
    ...
    protected void modifyImage(BufferedImage image) {
        for (
            ...
            ThreadPool.runTask(AugmentationMethodKit.getProjectionMethodThread(lu, ru, rd, ld, image, storageResult), priority);
        }
    }
